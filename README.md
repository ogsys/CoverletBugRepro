...
These were performed in PowerShell 7 on Windows 11, but probably work with other combinations.
...
```ps1
dotnet tool run coverlet -- MyLib.Tests\bin\Debug\net48\MyLib.Tests.dll -t dotnet -a "test --no-build" --verbosity detailed
```
